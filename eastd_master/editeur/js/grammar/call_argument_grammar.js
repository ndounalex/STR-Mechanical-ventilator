...
var call_parameters_grammar_object = {
    Lexer: lexer,
    ParserRules: [
    {"name": "call_argument", "symbols": ["identifier"], "postprocess": (d) => {return {"type":"identifier","value":d[0]}  }},
    {"name": "call_argument", "symbols": ["json"], "postprocess": (d) => {return {"type":"json","value":d[0]}  }},
    {"name": "call_argument", "symbols": ["objet_attribute"], "postprocess": (d) => {return {"type":"member_accessor","value":d[0]}  }},
  ...
  , ParserStart: "call_argument"
}
if (typeof module !== 'undefined'&& typeof module.exports !== 'undefined') {
   module.exports = call_parameters_grammar_object;
} else {
   window.call_parameters_grammar_object = call_parameters_grammar_object;
}
})();
