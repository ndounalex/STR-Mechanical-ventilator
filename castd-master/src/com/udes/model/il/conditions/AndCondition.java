...
public class AndCondition extends Condition {
    ...
    public AndCondition(List<Condition> condition) {
    ...
    public Condition updateInstruction(List<Variable> varList, ArrayList<ASTD> ASTDTree) {
        ...
        if(cList != null) {
            cList.forEach(c -> newList.add(c.updateInstruction(varList, ASTDTree)));
    ...
    public String generateCode(ILTranslator.Lang lang, ResourceBundle bundle) {
        return junction(getCondition(), "AND", lang, bundle);
    }
